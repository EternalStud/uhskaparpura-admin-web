...
import { initLoginView } from "./login.js?v=1.2.6";
import { initDashboardView } from "./dashboard.js?v=1.2.6";
import { initSubjectTagView } from "./modules/subjectTag.js?v=1.2.6";
